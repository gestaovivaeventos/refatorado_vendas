...
export default async function handler(
  ...
  try {
    ...
    if (!forceRefresh && cache && Date.now() - cache.timestamp < CACHE_TTL) {
      console.log('[API/funil] Retornando dados em cache');
    ...
    console.log('[API/funil] Buscando dados do Google Sheets...');
    ...
    console.log('[API/funil] Dados recebidos:', rows.length, 'linhas');
